...
//1. splice for insertion by replacing elements
var arrayOfRollNumbers = [67, 56, 78, 99, 80];
console.log(arrayOfRollNumbers);
...
array.splice(1, 0, "Bill", "Stew");
console.log(array);
// return elememnt,,,,,Array Traversing
var arrayNames = ["Anil", "Siya", "Ram", "Sunil", "Jenny"];
let element =  arrayNames[4];
console.log(element);
...
console.log("------------------WAP to get even indexrd elemen-----------------t ");
var array = ["Anil", "Siya", "Ram", "Sunil", "Jenny"];
// WAP tp get even indexed elememt 
for (const index in arrayNames) {
    if (index%2==0) {
        console.log(`${arrayNames[index]}`);
...
const arrayBoys = ["Anil", "Siya", "Ram", "Sunil", "Jenny"];
